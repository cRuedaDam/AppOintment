package com.example.reservapp.commerce.view.activities.menu.employees
...
import com.example.reservapp.databinding.ActivityCommerceEmployeesBinding
...
class CommerceEmployees : AppCompatActivity() , EmployeeAdapter.OnEmployeeFilterListener {
    ...
    private fun filteredSearch(){
        ...
        employeeAdapter = EmployeeAdapter(employeeList) // Iguala el adaptador a la lista recibida desde el Employee Adapter
