...
import com.example.reservapp.databinding.ActivityCommerceEditProfileBinding
    ...
    private fun fillListView() {
        ...
        listViewItems.setOnItemClickListener { _, _, position, _ ->
            when (position) {
                ...
                //4 -> startActivity(Intent(this, ChangeCommerceSchedule::class.java))
                ...
                5 -> CustomAlertDialog.showAlertDialog(
                    ...
                    onAccept = {
                        ...
                        Toast.makeText(this, "La cuenta ha sido eliminada correctamente", Toast.LENGTH_SHORT).show()
