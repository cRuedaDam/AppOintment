package com.example.reservapp.commerce.view.activities
...
import com.example.reservapp.databinding.ActivityCommerceSignUpBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSignUp.setOnClickListener() {
            ...
            if (commerceName.trim().isNotEmpty() && commercePhoneNumber.trim().isNotEmpty()
                ...
                && commercePassword.trim().isNotEmpty() && commerceConfirmPassword.trim().isNotEmpty()
            ) {
            ...
            MainScope().launch(Dispatchers.IO) {
                firebaseAuth.createUserWithEmailAndPassword(commerceEmail, commercePassword)
                    .addOnCompleteListener {
                        if (it.isSuccessful) {
                            val commerce = FirebaseAuth.getInstance().currentUser // Apunta al usuario
