package com.example.reservapp.commerce.view.activities.home
...
import com.example.reservapp.commerce.view.adapters.AppointmentAdapter
import com.example.reservapp.commerce.viewModel.FireBaseManager
import com.example.reservapp.common.model.Appointment
import com.example.reservapp.databinding.ActivityCommerceHomeBinding
                        ...
                        if (isAppointmentForCurrentDate(appointmentDate, selectedDate)) {
                            ...
                            firebaseManager.getServiceNameById(appointment.serviceId) { serviceName ->
                                ...
                                firebaseManager.getUserNameByUid(appointment.userId) { userName ->
                                    ...
                                    updateRecyclerView()
                                    Log.d("CommerceHome1", "Appointment List Size: ${appointmentList.size}")
        ...
        if (commerceId != null) {
            ...
            storageReference.putFile(imageUri)
                ...
                .addOnFailureListener { exception ->
                    ...
                    Log.d("URLImage","La imagen No se ha actualizado corectamente")
                }
        }
    }
    ...
    private fun saveImageUriToFirestore(imageUri: String, commerceId: String) {
        ...
        commerceRef.update("commerce_picture", imageUri)
            .addOnSuccessListener {
                Log.d("URLImage","La imagen se ha actualizado corectamente")
            }
            .addOnFailureListener { exception ->
