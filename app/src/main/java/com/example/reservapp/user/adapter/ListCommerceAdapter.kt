 ...
 * y el recyclerView
 */
class ListCommerceAdapter(private var listCat: ArrayList<CommerceItem>, private val onClickItem:(CommerceItem) -> Unit): RecyclerView.Adapter<ListCommerceAdapter.UsrListViewHolder>(){
   inner class UsrListViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        */
       fun bind(item: CommerceItem, onClickItem: (CommerceItem) -> Unit) {
    ...
    fun setFilteredList(filteredList: ArrayList<CommerceItem>) {
        this.listCat = filteredList
