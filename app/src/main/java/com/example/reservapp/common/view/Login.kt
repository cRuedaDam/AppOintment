...
import com.example.reservapp.user.CustomerHome
...
class Login : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        firebaseAuth =
            FirebaseAuth.getInstance() // Inicializamos la instancia del autentificador de firebase


        //Ir a Registro de Usuario
        linkToSignUp.setOnClickListener() {
            var intent = Intent(this@Login, CustomerOrCommerce::class.java)
    ...
    private fun checkUserType() {
        ...
        if (userId != null) {
            // Utilizar GlobalScope.launch para ejecutar la tarea en segundo plano
            ...
            MainScope().launch(Dispatchers.IO) {
                try {
                    ...
                    if (documentSnapshot.exists()) {
                        ...
                        // El usuario es un comercio, redirigir a la pantalla principal
                        launch(Dispatchers.Main) {
